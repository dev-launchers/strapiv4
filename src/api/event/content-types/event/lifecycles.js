module.exports = {
    ...
    async afterCreate(event) {
        ...
        const { id, entityId, entityType } = event.result;

        try {
            // Fetch all users with active subscriptions for the given entityId and entityType
            ...
            console.log(`Notifications created for event ${id} and ${subscriptions.length} subscribed users.`);
        } catch (error) {
